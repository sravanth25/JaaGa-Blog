...
export default function AboutPage() {
  usePageMeta({
    title: "About JaaGa | Building Trust in Indian Real Estate",
    description: "JaaGa.ai brings transparency, security, and simplicity to the Indian property market. We leverage technology to empower owners and buyers with property data and services.",
    keywords: "JaaGa, about JaaGa, Indian real estate, property verification, property documents",
    canonical: "https://blog.jaaga.ai/about",
    ogTitle: "About JaaGa | Building Trust in Indian Real Estate",
    ogDescription: "JaaGa.ai brings transparency, security, and simplicity to the Indian property market.",
    ogType: "website",
  });

  useWebPageSchema(
    "About JaaGa | Building Trust in Indian Real Estate",
    "JaaGa.ai brings transparency, security, and simplicity to the Indian property market. We leverage technology to empower owners and buyers with property data and services."
  );
