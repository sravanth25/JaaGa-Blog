...
export default function BlogEditorPage() {
  usePageMeta({
    title: "Blog Editor | JaaGa Insights",
    description: "Create and manage blog posts for JaaGa Insights.",
    keywords: "blog editor, JaaGa admin",
    canonical: "https://blog.jaaga.ai/blogs/editor",
  });

  useWebPageSchema("Blog Editor | JaaGa Insights", "Create and manage blog posts for JaaGa Insights.");
