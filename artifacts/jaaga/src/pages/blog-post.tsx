...
export default function BlogPostPage() {
  ...
  usePageMeta(post ? {
    ...
    canonical: post.canonicalUrl || `https://blog.jaaga.ai/blogs/${post.slug}`,
    ...
    twitterTitle: post.ogTitle || post.metaTitle || post.title,
    twitterDescription: post.ogDescription || post.metaDescription || post.excerpt,
    twitterImage: post.featuredImage || undefined,
  } : {
    title: "Blog Post",
  });
